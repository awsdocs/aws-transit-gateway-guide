# Transit Gateway Scenario: Isolated VPCs with Shared Services<a name="transit-gateway-isolated-shared"></a>
...
+ Four attachments on the transit gateway for the four VPCs\. For more information, see [Create a Transit Gateway Attachment to a VPC](https://docs.aws.amazon.com/vpc/latest/tgw//tgw-vpc-attachments.html)\.
