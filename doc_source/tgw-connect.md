# Transit gateway Connect attachments and Connect peers<a name="tgw-connect"></a>
...
+ [Create a Connect peer \(GRE tunnel\)](#create-tgw-connect-peer)
+ [View your transit gateway Connect attachments and Connect peers](#view-tgw-connect-attachments)
+ [Modify your Connect attachment and Connect peer tags](#modify-connect-attachment-tag)
+ [Delete a Connect peer](#delete-tgw-connect-peer)
+ [Delete a transit gateway Connect attachment](#delete-tgw-connect-attachment)

## Connect peers<a name="tgw-connect-peer"></a>
...
|  ![\[Image NOT FOUND\]](http://docs.aws.amazon.com/vpc/latest/tgw/images/GRE-tunnel.png)  | GRE tunnel \(Connect peer\) | 
...
## Create a Connect peer \(GRE tunnel\)<a name="create-tgw-connect-peer"></a>

You can create a Connect peer \(GRE tunnel\) for an existing Connect attachment\. Before you begin, ensure that you have configured a transit gateway CIDR block\. You can configure a transit gateway CIDR block when you [create](tgw-transit-gateways.md#create-tgw) or [modify](tgw-transit-gateways.md#tgw-modifying) a transit gateway\. 
...
1. \(Optional\) For **Connect Peer name tag**, specify a name tag for the Connect peer\.
...
## View your transit gateway Connect attachments and Connect peers<a name="view-tgw-connect-attachments"></a>
...
## Modify your Connect attachment and Connect peer tags<a name="modify-connect-attachment-tag"></a>
...
1. Select the Connect peer and then choose **Actions**, **Add/Edit tags**\.
...
## Delete a Connect peer<a name="delete-tgw-connect-peer"></a>
